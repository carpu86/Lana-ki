...
def create_mcp_router() -> APIRouter:
    ...
    async def invoke_tool(request: Request) -> JSONResponse:
        ...
        if isinstance(payload, dict) and payload.get("method"):
            ...
            if method == "tools/call":
                ...
                try:
                    ...
                    return mcp_error_response(request_id, -32000, str(exc), status.HTTP_400_BAD_REQUEST)
        ...
        try:
            ...
            return mcp_json_response({"ok": False, "error": str(exc)}, status_code=status.HTTP_400_BAD_REQUEST)
