...
async function queryAI(message, provider) {
    try {
        switch (provider) {
            ...
            case 'xai':
                if (!process.env.XAI_API_KEY) throw new Error('XAI nicht konfiguriert');
...
app.get('/', (req, res) => {
    ...
    const htmlContent = `
        ...
        <div style="margin: 0; padding: 0; border: 1px solid #ccc;">
            <h3>🤖 Single AI Test</h3>
            <textarea id="singleMessage" placeholder="Deine Nachricht..." style="width: 100%; height: 60px;"></textarea><br>
            <select id="provider" style="margin: 0; padding: 0;">
                <option value="openai">OpenAI</option>
                <option value="gemini">Gemini</option>
                <option value="groq">Groq</option>
                <option value="xai">XAI</option>
            </select>
            <button onclick="testSingleAI()" style="margin: 0; padding: 0;">Testen</button>
            <div id="singleResult" style="margin-top: 10px; padding: 0; background: #f5f5f5;"></div>
        </div>
        ...
        <div style="margin: 0; padding: 0; border: 1px solid #ccc;">
            ...
            <button onclick="testMultiAI()" style="margin: 0; padding: 0;">Alle AIs Testen</button>
            <div id="multiResult" style="margin-top: 10px; padding: 0; background: #f5f5f5;"></div>
        </div>
